...
class SettingViewController: UITableViewController {
    ...
    @IBOutlet weak var authenticationCell: UITableViewCell!
    ...
    override func viewDidLoad() {
        ...
        userNameLabel.text = AWSIdentityManager.defaultIdentityManager().userName!
        profileImageView?.downloadWithUrl((AWSIdentityManager.defaultIdentityManager().imageURL?.absoluteString)!)
