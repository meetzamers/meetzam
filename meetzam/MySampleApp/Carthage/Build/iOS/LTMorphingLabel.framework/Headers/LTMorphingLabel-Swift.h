...
SWIFT_CLASS("_TtC15LTMorphingLabel13LTEmitterView")
...
@property (nonatomic) NSInteger totalDelayFrames;
@property (nonatomic) float totalWidth;
@property (nonatomic, copy) NSArray<NSValue *> * _Nonnull previousRects;
@property (nonatomic, copy) NSArray<NSValue *> * _Nonnull newRects;
@property (nonatomic) CGFloat charHeight;
@property (nonatomic) NSInteger skipFramesCount;
@property (nonatomic, readonly) BOOL presentingInIB;
...
@property (nonatomic, strong) LTEmitterView * _Nonnull emitterView;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
- (NSArray<NSValue *> * _Nonnull)rectsOfEachCharacter:(NSString * _Nonnull)textToDraw withFont:(UIFont * _Nonnull)font SWIFT_WARN_UNUSED_RESULT;
@end
